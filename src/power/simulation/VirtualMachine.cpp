...
VirtualMachine::VirtualMachine(const std::vector<uint8_t>& executable_data, uint64_t loader_ptr)
: mMachine(executable_data), mLoaderPtr(loader_ptr) {
...
void VirtualMachine::start() {
	uint64_t cartridgePtr = mMachine.vmcall("load_cartridge", mLoaderPtr);
