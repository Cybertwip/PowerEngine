...
Pin& Node::add_input(int pin_id, int node_id, const std::string& label, PinType pin_type) {
...
Pin& Node::add_output(int pin_id, int node_id, const std::string& label, PinType pin_type) {
...
void Node::perform_layout(NVGcontext *ctx) {
