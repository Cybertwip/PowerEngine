...
std::unique_ptr<MeshActorImporter::CompressedMeshActor> MeshActorImporter::processFbx(const std::string& path, const std::string& destination) {
...
std::unique_ptr<MeshActorImporter::CompressedMeshActor> MeshActorImporter::processFbx(std::stringstream& data, const std::string& modelName, const std::string& destination) {
...
std::unique_ptr<MeshActorImporter::CompressedMeshActor> MeshActorImporter::processGr2(const std::string& path, const std::string& destination) {
	
	auto actor = std::make_unique<CompressedMeshActor>();
	
	auto meshSerializer = std::make_unique<CompressedSerialization::Serializer>();
	
	auto model = std::make_unique<SkinnedGr2>();
...
std::unique_ptr<MeshActorImporter::CompressedMeshActor> MeshActorImporter::processGr2(std::stringstream& data, const std::string& modelName, const std::string& destination) {
