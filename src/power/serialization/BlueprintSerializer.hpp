 ...
 * =====================================================================================
 *
 * Filename:  BlueprintSerializer.hpp
 *
 * Description:  Header file for the BlueprintSerializer class.
 *
 * =====================================================================================
 */
#pragma once
 ...
 * This class reads from and writes to standalone blueprint asset files using FlatBuffers.
 */
class BlueprintSerializer {
public:
