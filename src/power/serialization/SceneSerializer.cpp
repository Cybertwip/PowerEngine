...
// INTEGRATION: Include the new ID component and UUID generator
...
// FIX: Changed namespace to Power::Schema to match your code
...
void SceneSerializer::register_component<TransformComponent>() {
    // FIX: Use .hash() to get the integer type ID from entt
    ...
    // FIX: The generated FlatBuffers enum is ComponentData_TransformComponent
...
void SceneSerializer::register_component<CameraComponent>() {
    ...
    m_serializers[type_id] = {
        ...
        .deserialize = [](entt::registry& registry, entt::entity entity, const void* data) {
            ...
            // This now works reliably because the two-pass deserialize ensures TransformComponent exists.
    ...
    // FIX: The generated FlatBuffers enum is ComponentData_CameraComponent
    m_component_type_map[static_cast<uint8_t>(Power::Schema::ComponentData_CameraComponent)] = type_id;
}

// IDComponent Registration
template<>
...
// --- Main Serialization/Deserialization Logic (UPDATED) ---
...
void SceneSerializer::serialize(entt::registry& registry, const std::string& filepath) {
    ...
    for (auto entity_handle : id_view) {
        ...
        for (auto&& [type_id, storage] : registry.storage()) {
            // FIX: Compare the integer hash values for the type IDs
            if (type_id != entt::type_id<IDComponent>().hash() && storage.contains(entity_handle) && m_serializers.count(type_id)) {
                ...
                if (serializer.serialize) {
                    ...
                    // FIX: The generated FlatBuffers enum for NONE is ComponentData_NONE
