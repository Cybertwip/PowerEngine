...
mApplicationClickRegistrator(applicationClickRegistrator) {
	...
	mResourcesPanel = std::make_shared<ResourcesPanel>(parent.parent()->get(), screen, *rootNode, mActorVisualManager, mSceneTimeBar, animationTimeProvider, mMeshActorLoader, mShaderManager, deepMotionApiClient, OpenAiApiClient, mUiManager);
