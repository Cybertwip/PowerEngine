...
mApplicationClickRegistrator(applicationClickRegistrator) {
	...
	mResourcesPanel = std::make_shared<ResourcesPanel>(parent.parent()->get(), screen, *rootNode, mActorVisualManager, mSceneTimeBar, animationTimeProvider, previewTimeProvider, mMeshActorLoader, mShaderManager,/* deepMotionApiClient, powerAi,*/ mUiManager);
