...
public:
	ImportWindow(std::weak_ptr<Widget> parent, std::shared_ptr<ResourcesPanel> resourcesPanel, std::shared_ptr<nanogui::RenderPass> renderpass, ShaderManager& shaderManager);
