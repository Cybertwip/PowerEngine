...
DeepMotionSettingsWindow::DeepMotionSettingsWindow(std::shared_ptr<Widget> parent, DeepMotionApiClient& deepMotionApiClient, std::function<void()> successCallback)
