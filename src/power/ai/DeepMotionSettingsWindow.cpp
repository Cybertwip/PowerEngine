...
DeepMotionSettingsWindow::DeepMotionSettingsWindow(std::weak_ptr<Widget> parent, DeepMotionApiClient& deepMotionApiClient, std::function<void()> successCallback)
