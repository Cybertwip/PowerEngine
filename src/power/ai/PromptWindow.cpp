...
PromptWindow::PromptWindow(nanogui::std::shared_ptr<Widget> parent, ResourcesPanel& resourcesPanel, DeepMotionApiClient& deepMotionApiClient, nanogui::RenderPass& renderpass, ShaderManager& shaderManager)
