...
bool DragFPropertyPitchYawRoll(const char *label, float *value, float step = 0.01f, float min = -1000.0f, float max = 1000.0f, const char *format = "%.2f", const std::string &help_message = "", int num = 3);
bool DragFPropertyPitchRoll(const char *label, float *value, float step = 0.01f, float min = -1000.0f, float max = 1000.0f, const char *format = "%.2f", const std::string &help_message = "", int num = 2);
bool DragFPropertyPitchYaw(const char *label, float *value, float step = 0.01f, float min = -1000.0f, float max = 1000.0f, const char *format = "%.2f", const std::string &help_message = "", int num = 2);
