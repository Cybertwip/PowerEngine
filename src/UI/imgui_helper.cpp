...
bool DragFPropertyXYZ(const char *label, float *value, float step, float min, float max, const char *format, const std::string &help_message, int num)
{
	...
	for(int n = 1; n < num; ++n){
		ImGui::PushItemWidth(available / num);
	}
...
bool DragFPropertyPitchYawRoll(const char *label, float *value, float step, float min, float max, const char *format, const std::string &help_message, int num)
{
	bool is_value_changed = false;
	ImGui::PushID(label);
	ImGui::Columns(2, nullptr, false);
	...
	const char *button_labels[] = {"Pitch", "Yaw", "Roll", "W"};
	const char *drag_labels[] = {"##Pitch", "##Yaw", "##Roll", "##w"};
...
bool DragFPropertyPitchYaw(const char *label, float *value, float step, float min, float max, const char *format, const std::string &help_message, int num)
{
	bool is_value_changed = false;
	ImGui::PushID(label);
	ImGui::Columns(2, nullptr, false);
	...
	const char *button_labels[] = {"Pitch", "Yaw"};
	const char *drag_labels[] = {"##Pitch", "##Yaw"};
...
bool DragFPropertyPitchRoll(const char *label, float *value, float step, float min, float max, const char *format, const std::string &help_message, int num)
{
	bool is_value_changed = false;
	ImGui::PushID(label);
	ImGui::Columns(2, nullptr, false);
	...
	const char *button_labels[] = {"Pitch", "Roll"};
	const char *drag_labels[] = {"##Pitch", "##Roll"};
	...
	for (int i = 0; i < 2; i++)
	{
		...
		if (i == 0){
			...
			button_color[i + 1] = framebg_hovered_color[i] = framebg_active_color[i] = framebg_color[i] = 0.9f;
		}
