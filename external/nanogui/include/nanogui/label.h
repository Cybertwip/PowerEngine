/*
 nanogui/label.h -- Text label with an arbitrary font, color, size, and alignment
 ...
 *
 * The font, color, and alignment can be customized. When \ref Widget::set_fixed_width()
