...
ImageView::ImageView(Widget& parent, Screen& screen) : Canvas(parent, screen, 1, true, true) {
    ...
    m_image_border_color = theme().m_border_dark;
...
bool ImageView::mouse_button_event(const Vector2i &, int , bool, int) {
	return false;
}
