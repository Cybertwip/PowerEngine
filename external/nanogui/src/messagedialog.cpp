...
MessageDialog::MessageDialog(Widget& parent, Screen& screen, Theme& theme,  Type type, const std::string &title,
              const std::string &message,
              const std::string &button_text,
              const std::string &alt_button_text, bool alt_button) : Window(parent, screen, theme, title) {
