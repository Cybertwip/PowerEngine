...
MessageDialog::MessageDialog(Widget& parent, Screen& screen,  Type type, const std::string &title,
              const std::string &message,
              const std::string &button_text,
              const std::string &alt_button_text, bool alt_button) : Window(parent, screen, title) {
    set_layout(std::make_unique<BoxLayout>(Orientation::Vertical,
...
//    int icon = 0;
//    switch (type) {
//        case Type::Information: icon = theme().m_message_information_icon; break;
//        case Type::Question: icon = theme().m_message_question_icon; break;
//        case Type::Warning: icon = theme().m_message_warning_icon; break;
//    }
...
//    Widget& panel2 = std::make_shared<Widget>(*this);
//    panel2->set_layout(std::make_shared<BoxLayout>(Orientation::Horizontal,
//                                     Alignment::Middle, 0, 15));
//
//    if (alt_button) {
//        Button *button = new Button(panel2, alt_button_text, theme().m_message_alt_button_icon);
//        button->set_callback([&] { if (m_callback) m_callback(1); dispose(); });
//    }
//    Button *button = new Button(panel2, button_text, theme().m_message_primary_button_icon);
