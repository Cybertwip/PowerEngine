...
ImagePanel::ImagePanel(Widget& parent, Screen& screen, Theme& theme)
    : Widget(parent, screen, theme), m_thumb_size(64), m_spacing(10), m_margin(10),
      m_mouse_index(-1) {}
...
Vector2i ImagePanel::preferred_size(NVGcontext *) {
