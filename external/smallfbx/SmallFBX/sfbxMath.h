...
constexpr double PI = 3.14159265358979323846264338327950288419716939937510f;
constexpr double DegToRad = PI / 180.0f;
constexpr double RadToDeg = 1.0f / (PI / 180.0f);
constexpr double InchToMillimeter = 25.4f;
constexpr double MillimeterToInch = 1.0f / 25.4f;
constexpr double PercentToWeight = 1.0f / 100.0f;
constexpr double WeightToPercent = 100.0f;
