...
void GRANNY
BuildSingleCompositeFromWorldPose(
...
void GRANNY
BuildSingleCompositeFromWorldPoseTranspose(
    real32 const *InverseWorld4x4, real32 const *WorldMatrix,
...
void GRANNY
BuildIdentityWorldPoseComposite(
    real32 const *ParentMatrix,
    real32 const *InverseWorld4x4,
    real32 *ResultComposite, real32 *ResultWorldMatrix)
{
    BuildIdentityWorldPoseOnly(ParentMatrix, ResultWorldMatrix);
    BuildSingleCompositeFromWorldPose(InverseWorld4x4, ResultWorldMatrix, ResultComposite);
}

void GRANNY
BuildPositionWorldPoseComposite(
    real32 const *Position,
    real32 const *ParentMatrix,
    real32 const *InverseWorld4x4,
    real32 *ResultComposite, real32 *ResultWorldMatrix)
{
    BuildPositionWorldPoseOnly(Position, ParentMatrix, ResultWorldMatrix);
    BuildSingleCompositeFromWorldPose(InverseWorld4x4, ResultWorldMatrix, ResultComposite);
}
...
BuildPositionOrientationWorldPoseComposite(
    ...
    real32 *ResultComposite, real32 * ResultWorldMatrix)
{
    BuildPositionOrientationWorldPoseOnly(Position, Orientation, ParentMatrix, ResultWorldMatrix);
    BuildSingleCompositeFromWorldPose(InverseWorld4x4, ResultWorldMatrix, ResultComposite);
}

void GRANNY
BuildFullWorldPoseComposite(
    transform const &Transform,
    real32 const *ParentMatrix, real32 const *InverseWorld4x4,
    real32 *ResultComposite, real32 * ResultWorldMatrix)
{
