...
int32x const DataTypeNameOffset64          = 8;
int32x const DataTypeReferenceTypeOffset64 = 16;

// Do as much checking as we can...
CompileAssert(SizeOf(uintaddrx) == SizeOf(void*));
//CompileAssert(SizeOf(data_type_definition) == (DataTypeDefBaseSize + 3 * SizeOf(uintaddrx) + 4));
