...
PreferenceFonts = {
   [ "label_text" ]   = UIFont.Get("Trebuchet", 9, true, false),
   [ "comment_text" ] = UIFont.Get("consolas", 9, true, false),

   [ "button" ]               = UIFont.Get("Trebuchet", 11, true, false),
   [ "lbmbutton_text_below" ] = UIFont.Get("Arial", 10, false, false),
   [ "lbmbutton_text_side" ]  = UIFont.Get("Arial", 10, false, false),
   [ "tabview_tab" ]          = UIFont.Get("Trebuchet", 9, false, false),
   [ "combobox" ]             = UIFont.Get("Trebuchet", 11, true, false),

   [ "node_title" ]           = UIFont.Get("Segoe UI", 9, false, false),
   [ "node_edge" ]            = UIFont.Get("Segoe UI", 8, true, false),

   [ "editbox" ]              = UIFont.Get("Arial", 11, false, false),

   [ "tooltip" ]              = UIFont.Get("Arial", 10, false, false),

   [ "table" ]                = UIFont.Get("consolas", 10, false, false),
   [ "console" ]              = UIFont.Get("consolas", 10, false, false),
   [ "log_strings" ]          = UIFont.Get("consolas", 12, false, false),

   [ "anim_list_file" ]       = UIFont.Get("consolas", 12, false, false),
   [ "anim_list_anim" ]       = UIFont.Get("consolas", 10, false, false),

   [ "slot_list_header" ]     = UIFont.Get("Trebuchet", 14, false, false),
   [ "slot_list_entry" ]      = UIFont.Get("Trebuchet", 11, false, false),
}
