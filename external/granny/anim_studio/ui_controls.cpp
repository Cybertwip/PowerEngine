             ...
             Justification   just)
{
    ...
    RenderText(handle, String, 0, renderPt.x, renderPt.y + bl, color);
                 ...
                 bool Small)
{
    ...
    if (UIAreaPush(Rect, client))
    {
        ...
        // Stack: Slider.Do, ControlID, Min, Max, Current
        lua_pcall(L, 4, 2, 0);
...
SliderOn(real32 Min,
         ...
         ControlIDGen& IDGen)
{
    return SliderOnInternal(Min, Max, Value, Rect, IDGen, false);
}
...
SmallSliderOn(real32 Min,
              ...
              ControlIDGen& IDGen)
{
    return SliderOnInternal(Min, Max, Value, Rect, IDGen, true);
}
                  ...
                  ControlIDGen& IDGen)
{
    ...
    real32 LineLength = GetGridSpacing() * 0.15f;
