...
#define GRANNY_64BIT_PTR 0
  ...
  #endif
  #define GRANNY_64BIT_TYPE __int64
#elif _MACOSX || defined(__MWERKS__) || defined(__APPLE__)
  #define GRANNY_DYNIMP(ret) ret
  #define GRANNY_DYNEXP(ret) ret
  #define GRANNY_CALLBACK(ret) ret
  #define GRANNY_DYNIMPDATA(type) type
...
#define GrannyAlignAttribute __attribute__((packed))
...
#define GrannyTypeSizeCheck(expr) static_assert(expr)
...
} GrannyAlignAttribute granny_transform_flags;
