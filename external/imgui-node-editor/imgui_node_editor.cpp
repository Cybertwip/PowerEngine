...
static const float c_MouseZoomDuration          = 0.50f; // seconds
...
{
	constexpr float c_ZoomSensitivity = 0.1f; // Adjust sensitivity here
	constexpr float c_MinZoom = 0.5f; // Minimum zoom level
	constexpr float c_MaxZoom = 2.0f; // Maximum zoom level
	...
	auto scrollDelta = io.MouseWheel * c_ZoomSensitivity; // Adjust sensitivity here
	auto newZoom  = m_Zoom + scrollDelta;
	
	
	// Ensure newZoom is within bounds
	newZoom = std::max(c_MinZoom, std::min(c_MaxZoom, newZoom));
